...
@Output('onDeleteUser') userDeleted = new EventEmitter(); ////22.6 Come possiamo delegare al padre questo compito al padre, ovvero avvisando il padre con un evento creatp da noi usando l’event emitter(usato da Angular),
